...
def lsh_mc(user_rank_matrix,user_style_matrix,P,Q,opts):
    ...
    # lsh_split_new = LSH.lsh_bucket_direct_split(test_lsh_index,split_number=3)
    # lsh_split_duplicate = LSH.lsh_bucket_direct_split(test_lsh_index,split_number=3,ratio=1.1)
    # # print(lsh_split)
